  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const extendedStatsResponse = await axios.get('/api/stats/extended');
        setExtendedStats(extendedStatsResponse.data);
        ...
        const contribResponse = await axios.get('/api/contributors', {
          params: { limit: 20 }
        });
        setContributors(contribResponse.data);
